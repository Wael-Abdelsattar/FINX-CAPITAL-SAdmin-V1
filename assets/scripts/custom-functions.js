            ...
            if ($(this).hasClass('with-pagination')) {
                ...
                $(this).DataTable({
                    ...
                    columnDefs: [
                        { orderable: true, targets: 0 },
                        { orderable: true, targets: 1 },
                        { orderable: true, targets: [2], className: 'text-right text-nowrap' },
                        { orderable: true, targets: [3], className: 'text-right' },
                        { orderable: true, targets: [4], className: 'text-right' },
                        { orderable: true, targets: [5], className: 'text-right' },
                        { orderable: true, targets: [6], className: 'text-right' },
                        { orderable: true, targets: [7], className: 'text-right' },
                        { orderable: true, targets: [8], className: 'text-center' },
                        { orderable: true, targets: [9], className: 'text-right' },
                ...
                $(this).DataTable({
                    ...
                    columnDefs: [
                        ...
                        { orderable: true, targets: [6], className: 'text-right' },
                        { orderable: true, targets: [7], className: 'text-right' },
                        { orderable: true, targets: [8], className: 'text-right' },
                        { orderable: true, targets: [9], className: 'text-right' },
                        { orderable: true, targets: [10], className: 'text-right' },
                ...
                $(this).DataTable({
                    ...
                    columnDefs: [
                        { orderable: true, targets: [12], className: 'text-right' },
                    ],
                    bAutoWidth: false,
                    aoColumns: [
                        { sWidth: '10%' },
